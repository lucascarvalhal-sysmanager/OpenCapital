...
export default function BrandbookLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)]">
      {/* ─── NAV ─── */}
      <nav className="fixed top-0 z-50 w-full border-b border-black/6 bg-[var(--bg-primary)]/80 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl px-6 md:px-12">
          <div className="flex h-16 items-center justify-between">
            ...
            <span className="rounded-full border border-black/10 px-3 py-1 font-mono text-xs text-[var(--text-tertiary)]">Brandbook v1.0</span>
          </div>
          {/* Tabs */}
      ...
      {/* ─── FOOTER ─── */}
      <footer className="border-t border-black/6 py-12">

  ...
  --transition-slow: 400ms ease;
      ...
      <Section id="spacing-grid" num="02" title="Spacing & Grid" subtitle="Sistema de grid fluido de 12 colunas com breakpoints responsivos, baseado na unidade espacial de 4px.">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="font-mono text-xs text-[var(--text-secondary)]">
              {[
                ...
                <tr key={r.bp} className="border-b border-[var(--border-default)]">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-8">
            span 8
          </div>
          <div className="col-span-12 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-4">
            span 4
          </div>
          <div className="col-span-6 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-4">
            span 4
          </div>
          <div className="col-span-6 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-4">
            span 4
          ...
          <div className="col-span-12 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-6">
            span 6
          </div>
          <div className="col-span-12 flex h-28 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)] sm:col-span-6">
            span 6
          </div>
          <div className="col-span-12 flex h-40 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)] font-mono text-xs text-[var(--text-tertiary)]">
            span 12 — full width
          </div>
        </div>
      </Section>
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          <div className="glow-card overflow-hidden rounded-2xl bg-[var(--bg-secondary)]">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--border-default)] text-left text-[10px] uppercase tracking-widest text-[var(--text-tertiary)]">
              ...
              <tbody className="text-sm">
                {[
                  ...
                  <tr key={r.asset} className="border-b border-[var(--border-default)]">
...
background-size: 24px 24px;`} />
          ...
          {/* Scanlines */}
          <div className="flex flex-col gap-3">
            <div className="flex h-40 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)]" style={{ backgroundImage: "repeating-linear-gradient(0deg, transparent, transparent 3px, rgba(255,255,255,0.02) 3px, rgba(255,255,255,0.02) 4px)" }}>
  ...
  rgba(255,255,255,0.02) 4px
          ...
          {/* Noise / Grain */}
          <div className="flex flex-col gap-3">
            <div className="relative flex h-40 items-center justify-center overflow-hidden rounded-2xl border border-[var(--border-default)] bg-[var(--bg-secondary)]">
          ...
          <table className="w-full text-left text-sm">
            ...
            <tbody className="text-xs text-[var(--text-secondary)]">
              {[
                ...
                <tr key={a.name} className="border-b border-[var(--border-default)]">
  ...
  100% { transform: translateX(100%); }
      ...
      <Section id="logos" num="08" title="Logos" subtitle="Sistema completo de logo com variantes, zona de segurança, tamanhos mínimos e regras de uso como componente do design system.">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          ...
          {/* Light bg */}
          <div className="flex flex-col gap-3">
            <div className="flex h-40 items-center justify-center rounded-2xl border border-[var(--border-default)] bg-[var(--color-capital-white)]">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex h-28 items-center justify-center rounded-xl border border-[var(--border-default)] bg-[var(--bg-secondary)]">
